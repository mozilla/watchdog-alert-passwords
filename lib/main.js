...
const passwordManager = require('passwordManager'); // initialize this
const { unsecuredLoginManager } = require('unsecuredLogin'); // initialize this
var tmp = {};
...
require('password_pane_manager'); // initialize this
    ...
    onAttach: function(worker) {
        worker.port.on('blur', function(msg) {
            ...
            function addAlert(alert) {
                if (Alerts.AlertManager.addAlert(alert))
                    Alerts.PopupAlertsManager.displayAlertBar(alert);
            }
            ...
            // Disable the in-content warnings for now.
