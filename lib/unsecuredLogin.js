...
var secureLoginChecker = {
    ...
    watchForAccountSetup: function(xulWindow, browser) {
      ...
      for (var i=0; i < document.forms.length; i++) {
        ...
        self.installPasswordHandlers(xulWindow, browser, pwFields);
      }
      } catch(e) {
        console.log(e);
      }
    ...
    installPasswordHandlers: function(xulWindow, browser, pwFields) {
        ...
        field.element.addEventListener('focus', function () {
          ...
          nBox.appendNotification("It looks like you need a password, would you like help?", "watchdog-password-generator-help",
                                  dataDir.url("css/security-medium.png"),
